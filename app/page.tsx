    ...
    <>
      ...
      <section className="max-w-2xl mx-auto px-4 py-6 text-center">
        <p className="text-sm text-gray-400 leading-relaxed">
          AI Shift Drift ist die kostenlose KI-Readiness-Plattform f&uuml;r Restaurants und Gastronomiebetriebe in Düsseldorf. 4 Scannern f&uuml;r Sichtbarkeit, Reputation, Agent-Bereitschaft und Sicherheit.
        </p>
      </section>
      <ProblemSection />
