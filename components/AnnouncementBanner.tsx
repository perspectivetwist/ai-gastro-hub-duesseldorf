...
export default function AnnouncementBanner() {
  ...
  if (pathname === "/duesseldorf-ki-studie-2026") return null;
  ...
  return (
    ...
    >
      <a
        href="/duesseldorf-ki-studie-2026"
      ...
      >
        ...
        <span>
          <span className="font-semibold">83% der Düsseldorfer Restaurants unsichtbar für KI.</span>{" "}
          Studie lesen
        </span>
        <span
