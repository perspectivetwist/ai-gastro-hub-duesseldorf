  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center">
        <div className="flex justify-center mb-6"><CityIcon city="duesseldorf" /></div>
        {/* Eyebrow */}
        <div
          className="mb-14 text-sm tracking-widest uppercase"
          style={{ color: "#FFFFFF" }}
        >
          AI-Readiness für die Düsseldorfer Gastronomie
        </div>

        {/* Hook Headline */}
        <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6 max-w-4xl">
          4 kostenlose KI-Scanner{" "}
          <span className="gradient-accent">f&uuml;r dein Restaurant in Düsseldorf</span>
        </h1>
        ...
        >
          ...
          deines Restaurants in der KI-&Auml;ra, kostenlos und in unter 30 Sekunden, speziell für Gastronomiebetriebe in Düsseldorf.
        </p>
